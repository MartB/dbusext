...
//
// If an error does occur, it will be returned to the user alongside a job ID of 0.s
...
func (c *Conn) getPropertiesObjectPath(unit dbus.ObjectPath, dbusInterface string) (map[string]interface{}, error) {
	var err error
	var props map[string]dbus.Variant

	obj := c.sysconn.Object("org.freedesktop.systemd1", unit)
...
func (c *Conn) GetUnitPropertiesFromObjectPath(unit dbus.ObjectPath) (map[string]interface{}, error) {
	return c.getPropertiesObjectPath(unit, "org.freedesktop.systemd1.Unit")
}
...
func (c *Conn) getPropertyObjectPath(unit dbus.ObjectPath, dbusInterface string, propertyName string) (*Property, error) {
	var err error
	var prop dbus.Variant
...
func (c *Conn) GetUnitPropertyObjectPath(unit dbus.ObjectPath, propertyName string) (*Property, error) {
	return c.getPropertyObjectPath(unit, "org.freedesktop.systemd1.Unit", propertyName)
}
...
func (c *Conn) GetUnitFileState(unit string) (unitstate string) {
	c.sysobj.Call("org.freedesktop.systemd1.Manager.GetUnitFileState", 0, unit).Store(&unitstate)
	return
}

func (c *Conn) GetUnit(unit string) (unitstate UnitFile) {
	c.sysobj.Call("org.freedesktop.systemd1.Manager.GetUnit", 0, unit).Store(&unitstate)
	return
}
...
func unitPathDirect(name string) dbus.ObjectPath {
	return dbus.ObjectPath(PathBusEscape(name))
}
